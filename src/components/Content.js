    ...
    return (
        <div className="bg-yellow-50 dark:bg-gray-900 min-h-screen flex flex-col justify-center items-center  relative py-10 transition duration-1000">
            ...
            <div className="relative h-screen flex flex-col justify-center items-center">
                ...
                <h1 className="lg:text-6xl md:text-5xl sm:text-2xl text-2xl font-black mb-7 font-mono text-center text-gray-900 dark:text-gray-50">
                    Muhamad Rizki Triyanto
                </h1>
                <h2 className="text-gray-900 text-center dark:text-gray-50 font-mono lg:text-2xl md:text-1xl sm:text-base text-base mb-8 ">
